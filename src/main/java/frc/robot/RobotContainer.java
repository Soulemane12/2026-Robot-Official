...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        operator.x().onTrue(m_intake.run(() -> m_intake.goTo(Constants.IntakeConstants.STOW)));
        operator.b().onTrue(m_intake.run(() -> m_intake.goTo(Constants.IntakeConstants.EXTENDED)));
        operator.y().onTrue(m_intake.run(() -> m_intake.goTo(Constants.IntakeConstants.INTAKE_POSITION)));
